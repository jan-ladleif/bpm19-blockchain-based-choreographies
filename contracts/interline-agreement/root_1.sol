...
//                           |__/
contract Factory_InterlineAgreement_root_1 is ChoreographyFactory {
    function create(bytes data)
        external
        returns (address newContract)
    {
        newContract = new InterlineAgreement_root_1(msg.sender, data);
...
//                              |___/         |_|       |__/
contract InterlineAgreement_root_1 is BaseChoreography {
    // -------------------------------------------------------------------------
    // data object storage
    // -------------------------------------------------------------------------
    uint32 total_charge;
        ...
        external
    {
        ...
        require (participants.hasRole(msg.sender, [1, 0, 0, 1, 1][task]));
